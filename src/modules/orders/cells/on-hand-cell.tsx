...
import { usePatchItemMFGMutation, usePatchMFGMutation } from '@/store/api/ebms/ebms'
...
export const OnHandCell: React.FC<OnHandCellProps> = ({ originItem, disabled, key }) => {
    ...
    const handlePatchSalesOrder = async (value: number, id: string) => {
        const handleFunction = key === 'orders' ? patchMFG : patchItemMFG
        try {
